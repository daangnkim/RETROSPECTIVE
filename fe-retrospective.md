...
1. 창 크기를 원하는 사이즈로 조절되게끔 하는 단축키가 있으면 좋겠다.
2. tailwind의 선택자들을 묶어서 작성할 수 있었으면 좋겠다. 


## 2. put, patch

put을 언제 써야하는지 잘 몰랐는데, 명확하게 전체 상태가 보여야하는 `설정`에서 사용해야함.


### 3. 멀티 스탭을 가진 작성 페이지 아키텍쳐
